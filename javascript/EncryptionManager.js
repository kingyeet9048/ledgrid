function en() {
    ...
    var encryptedUser = CryptoJS.MD5(document.getElementById('username').value).toString();;
    var encryptedPass = CryptoJS.MD5(document.getElementById('password').value).toString();;
